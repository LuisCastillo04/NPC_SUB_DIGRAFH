...
public class Algoritmos {
    ...
    /* Fuerza Bruta (BF) --------------------------------------------------- */
    public static <V> BFResult<V> bipartiteSubsetBF(Graph<V, DefaultEdge> G, int k) {
    ...
    /* Versión booleana para usar en pruebas ------------------------------- */
    public static <V> boolean bipartiteSubsetBF_bool(Graph<V, DefaultEdge> G, int k) {
        return bipartiteSubsetBF(G, k).found;
    }
